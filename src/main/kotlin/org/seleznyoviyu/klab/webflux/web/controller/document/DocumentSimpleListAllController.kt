...
import org.seleznyoviyu.klab.webflux.domain.service.document.DocumentSimpleListAllService
...
@RestController
class DocumentSimpleListAllController(
    private val service: DocumentSimpleListAllService,
    private val mapper: DocumentJsonMapper
) {

    @GetMapping("/document/list-all", produces = [MediaType.APPLICATION_NDJSON_VALUE])
